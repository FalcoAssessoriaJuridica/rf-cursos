...
# Nota: Easypanel usa VITE_SUPABASE_URI, mas o app usa VITE_SUPABASE_URL
ARG VITE_SUPABASE_URL
ARG VITE_SUPABASE_URI
ARG VITE_SUPABASE_ANON_KEY
ARG VITE_ADMIN_MASTER_PASSWORD

# Mapeia URI para URL se fornecido, garantindo compatibilidade
ENV VITE_SUPABASE_URL=${VITE_SUPABASE_URI:-$VITE_SUPABASE_URL}
